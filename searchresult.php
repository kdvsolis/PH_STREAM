        ...
        <div class="head">
          ...
          <br/>
			...
			{			
				...
				$total_pages_sql = "SELECT COUNT(*) FROM movie_list WHERE movie_title LIKE '%".$_GET['search']."%' LIMIT $offset, $no_of_records_per_page";
				$result = mysqli_query($connection, $total_pages_sql);
				$total_rows = mysqli_fetch_array($result)[0];
				$total_pages = ceil($total_rows / $no_of_records_per_page);
			
				$query = "SELECT * FROM movie_list WHERE movie_title LIKE '%".$_GET['search']."%'";
